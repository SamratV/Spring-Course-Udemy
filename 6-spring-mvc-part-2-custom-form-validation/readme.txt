NOTE:
	...
	2) SEE IN PART 1: Also add the hibernate jars highlighted in the image "jars.png", which is in the same directory.

	3) SEE IN PART 1: "src/resources/messages.properties" was added to define custom error messages.
...
PURPOSE:
	This project shows the way to create custom annotations. Also have
	a look at all the readme images and forked gists on GitHub.